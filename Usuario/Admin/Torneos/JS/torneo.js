function Torneo() {
    var tabla1 = "<div class='contenedor-tabla-NoAprobados'><h2>Torneos</h2><table id='tablaNoAprobados'> <tr>   <th id='col1'>Nombre</th> <th id='col1'>Fecha de inicio</th> <th id='col1'>Ver</th> </tr>          </table></div>";
    $("#tabla1").html(tabla1);
    if (datosTorneo() == 1) {
