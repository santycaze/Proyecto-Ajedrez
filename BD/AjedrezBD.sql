...
--
/*!50003 DROP PROCEDURE IF EXISTS `Administrador` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Administrador`()
BEGIN
	select * from Usuario,periodistas where Usuario.idUsuario = periodistas.idUsuario;
END ;;
DELIMITER ;
...
-- Dump completed on 2021-06-24  0:26:57
